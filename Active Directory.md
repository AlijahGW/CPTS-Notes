Here is a generalized penetration testing methodology based on your notes from the Forest machine. I have stripped out the specific target data (IPs, specific users) and replaced them with placeholders to make this a reusable guide for your GitHub.
...
Key Ports to Watch: 53 (DNS), 88 (Kerberos), 135 (RPC), 389/636 (LDAP/S), 445 (SMB), 593 (RPC over HTTP), 3268/3269 (Global Catalog).
